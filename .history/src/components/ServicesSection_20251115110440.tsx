...
import { Users, Trophy, Calendar, Button } from 'lucide-react';
  ...
  return (
    <section className="bg-soft-white py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 justify-center items-center max-w-4xl mx-auto">
            <ButtonComponent
